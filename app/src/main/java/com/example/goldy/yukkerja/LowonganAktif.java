 ...
 */
public class LowonganAktif extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =inflater.inflate(R.layout.fragment_lowongan_aktif, container, false);

        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Lowongan Aktif");
        recyclerView = v.findViewById(R.id.rvLowonganPerusahaan);
...
//        Daftar Lowongan
        if (session.getId()!= null){
            ...
            retrofit2.Call<ResponseModelLowongan> lowonganPunyaPerusahaan = apiRequest.lowonganPunyaPerusahaan(session.getId(),"1");
