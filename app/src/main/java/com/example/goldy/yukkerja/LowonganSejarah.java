 ...
 */
public class LowonganSejarah extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =inflater.inflate(R.layout.fragment_lowongan_sejarah, container, false);

        ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Lowongan Sejarah");
        recyclerView = v.findViewById(R.id.rvLowonganPerusahaanSejarah);
...
//        Daftar Lowongan
        if (session.getId()!= null){
            ...
            retrofit2.Call<ResponseModelLowongan> lowonganPunyaPerusahaan = apiRequest.lowonganPunyaPerusahaan(session.getId(),"2");
